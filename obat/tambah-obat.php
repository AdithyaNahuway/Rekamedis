...
if ($msg == 'added') {
 ...
 <strong><i class="bi bi-bag-check-fill aligh-top"></i>  Tambah obat baru berhasil..</strong>
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    class="text-decoration-none">
      <i class="bi bi-arrow-left-square-fill"></i>Kembali</a>
  </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form-group mb-3">
                <label for="nama" class="form-tabel">Nama</label>
                <input type="text" name="nama" class= "form-control" id="nama" placeholder="nama obat" required>
            </div>
            <div class="form-group mb-3">
                <label for="kegunaan" class="form-tabel">kegunaan</label>
                <textarea name="kegunaan" id="kegunaan" cols="" 
                rows="" class="form-control"
                 placeholder="kegunaan obat" required></textarea>
            </div>
