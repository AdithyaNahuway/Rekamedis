            ...
            while ($rm = mysqli_fetch_assoc($queryrm)) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="proses-data.php?id=<?= $rm['no_rm'] ?>&aksi=hapus-data" onclick="return confirm('Anda yakin mau menghapus data ini?')" class="btn btn-sm btn-outline-danger" title="Hapus data"><i class="bi bi-trash align-top"></i></a> 
                    </td>
                </tr>
            <?php }?>
        </tbody>
