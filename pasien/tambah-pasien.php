    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="form-group mb-3">
          ...
          <input type="tel" name="telpon" id="telpon" placeholder="telpon pasien" pattern="[0-9]{8,}" title="minimal 8 angka" class="form-control" required>
        </div>
        <div class="form-group mb-3">
          <label for="alamat" class="form-label">Alamat</label>
          <textarea name="alamat" id="alamat" class="form-control" placeholder="alamat pasien" required></textarea>
        </div>
        <div>
