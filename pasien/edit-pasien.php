       ...
       <input type="hidden" name="id" value="<?= $pasien['id'] ?>"> 
        <div class="form-group mb-3">
          ...
          <input type="text" name="nama" class="form-control" 
           id="nama" placeholder="nama pasien" value="<?= $pasien['nama'] ?>" required>
        </div>
        <div class="form-group mb-3">
          <label for="tgl_lahir" class="form-label">Tgl lahir</label>
          <input type="date" name="tgl_lahir" class="form-control"
         id="tgl_lahir" value="<?= $pasien['tgl_lahir']?>" required>
        </div>
        <div class="form-group mb-3">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender"
                 id="gender" value="P" required <?= ($pasien['gender'] == 'P') ? 'checked' : '';  ?>>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio"
                 name="gender" id="gender" value="W" <?= ($pasien['gender'] == 'W') ? 'checked' : '';  ?>>
        ...
        <div class="form-group mb-3">
          ...
          <input type="tel" name="telpon" id="telpon"
           ...
           title="minimal 8 angka" class="form-control" value="<?= $pasien['telpon'] ?>" required>
        </div>
        <div class="form-group mb-3">
          <label for="alamat" class="form-label">Alamat</label>
          <textarea name="alamat" id="alamat" 
          class="form-control" placeholder="alamat pasien" required><?= $pasien['alamat'] ?>
        </textarea>
        </div>
        <div>
